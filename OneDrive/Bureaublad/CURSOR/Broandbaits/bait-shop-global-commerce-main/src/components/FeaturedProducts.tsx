    ...
    <section className="py-16 bg-background">
      <div className="container">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div 
            className="relative p-8 rounded-xl water-gradient text-white text-center overflow-hidden group cursor-pointer hover-lift"
          ...
          <div 
            className="relative p-8 rounded-xl bg-secondary text-secondary-foreground text-center overflow-hidden group cursor-pointer hover-lift"
            onClick={() => handleNavigation('/products')}
          >
            ...
            <Button 
              variant="outline" 
              className="border-secondary-foreground/30 hover:bg-secondary-foreground hover:text-secondary"
              onClick={(e) => {
                e.stopPropagation();
          ...
          <div 
            className="relative p-8 rounded-xl bg-accent text-accent-foreground text-center overflow-hidden group cursor-pointer hover-lift"
            onClick={() => handleNavigation('/products')}
          >
            ...
            <Button 
              variant="outline" 
              className="border-accent-foreground/30 hover:bg-accent-foreground hover:text-accent"
              onClick={(e) => {
                e.stopPropagation();
                handleNavigation('/products');
              }}
