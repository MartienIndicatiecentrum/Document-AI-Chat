// Bros&Baits Migratie Test - ES Module versie
// Compatible met "type": "module" in package.json
...
// WooCommerce API functie met Node.js https module (ES Module versie)
...
async function testWooCommerceConnection() {
  ...
  try {
    ...
    if (error.message.includes('Request Error')) {
      ...
      console.log('   - Website is offline of onbereikbaar')
...
async function runFullTest() {
  console.log('🚀 Bros&Baits Migratie Test - ES Module versie')
  console.log('===============================================')
...
// Script uitvoeren
console.log('⏳ Starting Bros&Baits migration test (ES Module)...\n')
